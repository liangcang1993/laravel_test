...
<div class="container">
    ...
    <form  class="form-horizontal" role="form" action="{{ URL('admin/admin_role') }}" method="POST" >
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input type="text" id="" name="role_name" placeholder="角色名称" class="col-xs-10 col-sm-5" value="" required />
            </div>
        </div>
        <h4>选择权限</h4>
            ...
            $(function() {
                ...
                $table.bootstrapTable({
                    ...
                    onCheck:function(row){
                        var datas = $table.bootstrapTable('getData');console.log(row)
                        // 勾选子类
