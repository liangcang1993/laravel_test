...
<link rel="stylesheet" href="/css/select2.css" />
                    ...
                    <div class="page-content">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12">
                                ...
                                <form class="form-horizontal" id="form1" role="form" action="{{ URL('admin/admin_user') }}" method="POST">
                                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                    <input type="hidden" name="area_ids" id="area_ids" value="">
                                    <input type="hidden" name="school_ids" id="school_ids" value="">

                                    <div class="form-group">
                                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 姓名 </label>

                                        <div class="col-sm-9">
                                            <input type="text" id="" name="name" placeholder="姓名" class="col-xs-10 col-sm-5" value="{{old('name')}}" required />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" id="password" name="password" placeholder="密码" class="col-xs-10 col-sm-5" value="" required />
                                            <span class="help-inline col-xs-12 col-sm-7">
                                                <button class="btn btn-minier btn-yellow" type="button" onclick="randPassword(8)">生成随机密码</button>
                                            </span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" min="11" id="" name="phone" placeholder="手机" class="col-xs-10 col-sm-5" value="{{old('phone')}}" required />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="email" id="" name="email" placeholder="邮箱" class="col-xs-10 col-sm-5" value="{{old('email')}}"  />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <select name="role" id="">
                                                ...
                                                @foreach($role as $r)
                                                    <option type="checkbox"  value="{{$r['id']}}">{{$r['role_name']}}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                                <div class="checkbox">
                                                    <label>
                                                        <input name="is_super" type="checkbox" class="ace" />
        ...
        <script src="/js/bootstrap-multiselect.js"></script>
            ...
            function randPassword(length, special) {
              var iteration = 0;
              var password = "";
              var randomNumber;
